...
void MX_HRTIM1_Init(void)
{
  ...
  pCompareCfg.CompareValue = 0xAFDF;
  ...
  pCompareCfg.CompareValue = 0x8FDF;
  ...
  pOutputCfg.SetSource = HRTIM_OUTPUTSET_MASTERPER|HRTIM_OUTPUTSET_TIMPER;
  ...
  pOutputCfg.SetSource = HRTIM_OUTPUTSET_MASTERCMP1|HRTIM_OUTPUTSET_TIMPER;
  if (HAL_HRTIM_WaveformOutputConfig(&hhrtim1, HRTIM_TIMERINDEX_TIMER_B, HRTIM_OUTPUT_TB1, &pOutputCfg) != HAL_OK)
  {
    Error_Handler();
  }
  pOutputCfg.SetSource = HRTIM_OUTPUTSET_MASTERCMP2|HRTIM_OUTPUTSET_TIMPER;
  if (HAL_HRTIM_WaveformOutputConfig(&hhrtim1, HRTIM_TIMERINDEX_TIMER_C, HRTIM_OUTPUT_TC1, &pOutputCfg) != HAL_OK)
  {
    Error_Handler();
  }
  pOutputCfg.SetSource = HRTIM_OUTPUTSET_MASTERCMP3|HRTIM_OUTPUTSET_TIMPER;
...
void HAL_HRTIM_MspPostInit(HRTIM_HandleTypeDef* hrtimHandle)
{
  ...
  /* USER CODE END HRTIM1_MspPostInit 0 */
    ...
    PA11     ------> HRTIM1_CHB2
    */
    GPIO_InitStruct.Pin = PWM_SX_LS2_Pin|PWM_SX_HS2_Pin|PWM_DX_LS2_Pin|PWM_DX_HS2_Pin;
    ...
    GPIO_InitStruct.Pin = PWM_SX_HS1_Pin|PWM_SX_LS1_Pin|PWM_DX_HS1_Pin|PWM_DX_LS1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF13_HRTIM1;
